...
Most day-to-day work flows through **Events → Tickets**. The other modules support specific roles (designers in Design Requests + Hours; techs in Maintenance + Inventory + Parts; admins in Portal Admin + Settings).
