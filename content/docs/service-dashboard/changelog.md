...
- **Builder Studio routes and model selector added**: You can now access the Builder Studio directly from the Operations Workspace, start new marketing compositions, and pick from a selection of AI models to generate your content.
...
- **Fix open tracking and add campaign verification**: Marketing open tracking now works correctly, so you’ll see accurate open counts. The campaign builder also includes end‑to‑end verification for Alison, helping you validate campaigns before they go live.
## 2026-06-11
...
- **Ticket email replies routed to support mailbox**: When a client replies to a ticket email, their response now lands in the monitored support mailbox, so all communications are automatically captured for the Operations Workspace.
...
- **Corrected timezone for today’s events in calendar**: The calendar now displays today’s events using the correct local timezone. You’ll see the accurate start times for your activities without any time shift.
- **Stop reminders for completed workflows**: I’ve removed reminder notifications for workflows that are already finished, so you won’t get unnecessary alerts after a workflow is completed.
## 2026-05-24
...
- **WMATA walkthrough view cleaned up for clarity**: We've tidied the WMATA walkthrough view, so it looks cleaner and is easier to navigate.
...
- **Post-game reminders now work correctly**: We've corrected the post-game reminder process to use the proper database type, so reminders are now sent reliably after each game.
...
- **Ticket attachments now support video, PDF, audio, and Office docs**: You can now attach videos, PDFs, audio files, and Microsoft Office documents directly to tickets. This expands the range of files you can share with your team without needing external links.
## 2026-05-02
...
- **Tickets open in a new tab from list**: Now when you click a ticket in the list, it opens in its own browser tab. This lets you keep the ticket list visible while you work on the selected ticket.
## 2026-04-27
...
- **Enrich Salesforce data via ANC Slack bot**: You can now ask the @ANC Slack bot to pull and enrich Salesforce records, delivering richer customer details directly in Slack. This lets you get the information you need without leaving your conversation.
## 2026-04-25
...
- **Remove plus icon on Cancel actions**: When you cancel adding an event or a new support ticket, the plus icon no longer appears, giving you a cleaner, less confusing interface.
## 2026-04-22
...
- **AI Assistant Panel UI Refresh**: I've refreshed the AI assistant panel – navigation feels new, markdown looks better, and the UI is polished for a smoother chat experience.
