...
- **Opportunity Owner** — the ANC person who owns an opportunity in the CRM, chosen from the team's CRM users. It replaced Salesforce's "Account Executive".
...
| | |
|---|---|
| **AE** | Account Executive — the Salesforce-era name for the Opportunity Owner |
