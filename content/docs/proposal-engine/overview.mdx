...
**This view writes back into Twenty CRM** — the Opportunity in the CRM updates in real time as you move cards here. Same record, two surfaces.
...
- Every export attaches automatically to the Opportunity in Twenty
...
- Every analysis is saved at `/tools/rfp-analyzer/history/[id]` — revisit later

> The RFP Analyzer is **frozen** as of 2026-04-02 — production-approved, identical behavior required. No edits without explicit approval.
...
- Output is branded PDF + Word (.docx) — both attach to the Opportunity in Twenty automatically
- Drop a client's existing SOW into `/api/sow/scan` to get back a structured summary of in-scope / out-of-scope / acceptance criteria
...
**When to use it:** Onboarding a new team member, updating company branding, swapping the default SOW template, adjusting AI provider keys.

**What you can do:**
- Manage users and roles
- Update branding (logo, colors, default header/footer)
- Swap SOW templates (Premium SOW default, Installation SOW default)
- Configure AI providers (Gemini, OpenAI, Mercury, Z.AI, NVIDIA — each has its own key format)
...
- **How exports land in Twenty:** [Universal CRM Push](/docs/proposal-engine/features/universal-crm-push)
