...
**Why the checklist matters:** each missing field breaks something specific. No due date and the deal sorts to the bottom of the queue while its real deadline burns down. No linked <GlossaryTerm term="company" /> and you price without the account history — past installs, past pricing, service record. No opportunity owner and there is nobody to answer scope questions when you hit an ambiguity at 4 PM the day before the bid is due. Send incomplete records back to the deal owner before you start pricing, not after.
...
**What good looks like:** by 10 AM the twelve RFPs are ranked, each has an owner and a due date, and the two with missing scope details have questions already sent back to the opportunity owner. Triage is not pricing — it is making sure nothing dies quietly in the queue.
...
- [RFP to Win Workflow](/docs/workflows/rfp-to-win) — the full cross-tool map this track fits inside.
