...
- **2 new views for Natalia:** Backlog (`1c775cd3`), Win/Loss by League (`6aae4c98`)
...
- **Per-user favorites** pinned to sidebar for Jireh, Natalia, Alexis, Ahmad
...
- **Real-time ticket sync** from ANC Services → Twenty (was 15-min cron, now ~1s fire-and-forget)
...
- Pre-2021 data deletion — pending Jireh's cutoff year decision
